...
async function models() {
    model = undefined;
    console.log("MASUk");
    model = await tf.loadLayersModel('https://raw.githubusercontent.com/mf4lsb/test_modeljson/new-model/tfjs_files/model.json');
    ...
    var output;
    input = tf.tensor2d([[541, 497, 0.315102, 27]]);
